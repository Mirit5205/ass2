...
public class Line {
    ...
    public boolean isPointInSection(Point other) {
        //System.out.println(this.start().distance(other) + other.distance(this.end()) - this.length());

        return (this.start().distance(other) + other.distance(this.end()) - this.length() <= 0.000000005);
    }
    ...
    public Point closestIntersectionToStartOfLine(List<Point> interSectionPoints) {
