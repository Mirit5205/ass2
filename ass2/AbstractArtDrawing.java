        ...
        for (int j = 0; j < 10; j++) {
           if (i == j) {
              continue;
               ...
               System.out.println("x: " + intersectionPoint.getX());
               System.out.println("y: " + intersectionPoint.getY());
               double intersectionPointX = intersectionPoint.getX();
               double intersectionPointY = intersectionPoint.getY();
               d.fillCircle((int) intersectionPointX, (int) intersectionPointY, 3);
               }
            }
        }
    }
