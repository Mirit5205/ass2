...
public class Ball implements Sprite {
    ...
    /**
     * removing block from game enviorment.
     * @param b is the block we want to remove from the  game
     * enviorment.
     */
